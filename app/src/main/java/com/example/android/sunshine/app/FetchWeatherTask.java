...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        // query to see if location already exists
        ...
        //if row exists return ID, if not, insert new record
        if( locationCursor.moveToFirst() )  {
            int index = locationCursor.getColumnIndex(WeatherContract.LocationEntry._ID);
            id = locationCursor.getLong(index);
        }
        else {
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                int rows = mContext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI, cv);
            }
